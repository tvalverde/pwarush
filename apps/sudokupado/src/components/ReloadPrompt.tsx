						...
						<div className="flex gap-2 shrink-0 w-full">
							{needRefresh ? (
								<button
									...
									className="bg-white text-primary-text px-4 py-2 rounded-full font-hanken text-[10px] font-black uppercase tracking-wider flex items-center justify-center gap-2 flex-1 shadow-xs active:scale-95 transition-transform"
								>
