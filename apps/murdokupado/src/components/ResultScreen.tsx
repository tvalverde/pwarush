	...
	return (
		...
		>
			<div className="flex flex-col items-center gap-3">
				...
				<h1 className="font-display text-3xl font-bold uppercase tracking-widest-premium text-on-surface">
			...
			<div className="flex w-full max-w-xs flex-col gap-4 rounded-DEFAULT border border-outline-variant bg-surface-container-lowest p-6 shadow-xs">
				<div className="flex flex-col gap-1">
					...
					<span data-testid="murderer-name" className="font-display text-2xl font-bold text-error">
